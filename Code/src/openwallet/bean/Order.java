package openwallet.bean;
 ...
 public class Orders {
   ...
   public Order(int id_order, int id_user, int code_order, double total_price, String user_message, Date create_date_order, Date pay_date, Date delivery_date, Date confirm_date, double payment, String status) {
