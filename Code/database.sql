...
CREATE TABLE product {
	...
	create_date_product date DEFAULT 0000-00-00,
...
CREATE TABLE order {
	...
	delivery_address address DEFAULT NULL,
	invoice_address address DEFAULT NULL,
	user_message varchar(500) DEFAULT NULL,
	create_date_order date DEFAULT 0000-00-00,
...
CREATE TABLE item_order {
	...
	CONSTRAINT fk_item_order_user FOREIGN KEY (id_order) REFERENCES order (id_order),
