                    ...
                    <table class="short-table white" style="width: 95%" cellspacing="0" cellpadding="0">
                        ...
                        <tbody>
                            <c:forEach items="${ps}" var="p">
                                <tr>
                                    <td><a href="foreproduct?id_product=${p.id_product}"><img src="img/product/${p.id_product}.jpg" width="40px" height="40px"/></a></td>
                                    <td><a href="foreproduct?id_product=${p.id_product}">${p.name_product}</a></td>
